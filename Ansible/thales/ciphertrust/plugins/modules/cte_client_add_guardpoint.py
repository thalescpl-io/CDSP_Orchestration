...
from ansible_collections.thales.ciphertrust.plugins.module_utils.cte import client_add_guardpoint

DOCUMENTATION = '''
---
module: cte_client_add_guardpoint
...
options:
    ...
    client_id:
        description: 
            - ID of the CSI client to which the guardpoints need to be added
        required: true
        type: str
        default: null
    guard_paths:
...
- name: "Create CTE CSI Storage Group"
  thales.ciphertrust.cte_client_add_guardpoint:
    localNode:
...
def main():
    ...
    response = client_add_guardpoint(
            node=localNode,
            client_id=client_id,
