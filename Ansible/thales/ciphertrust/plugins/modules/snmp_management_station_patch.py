...
from ansible_collections.thales.ciphertrust.plugins.module_utils.snmp import patchManagementStation

DOCUMENTATION = '''
---
module: snmp_management_station_patch
...
options:
    localNode:
        ...
        elements:
            ...
            - bool
    managementStationId:
        description: ID of SNMP Management Station.
        required: true
        type: str
    security_name:
...
- name: "Create SNMP User"
  thales.ciphertrust.snmp_management_station_patch:
    localNode:
...
def main():    
    ...
    module = AnsibleModule(
            argument_spec=dict(
                ...
                managementStationId=dict(type='str', required=True),
                security_name=dict(type='str', required=True),
            ),
        )

    localNode = module.params.get('localNode');
    managementStationId = module.params.get('managementStationId');
    ...
    response = patchManagementStation(
        node=localNode,
