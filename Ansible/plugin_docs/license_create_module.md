...
::: {#ansible_collections.thales.ciphertrust.license_create_module}
:::

thales.ciphertrust.license\_create module \-- This is a Thales CipherTrust Manager module for working with the CipherTrust Manager APIs.
========================================================================================================================================
...
To use it in a playbook, specify: `thales.ciphertrust.license_create`.
:::
...
-   This is a Thales CipherTrust Manager module for working with the
    CipherTrust Manager APIs, more specifically with trials management
    API
...
|  id="parameter-bind_type"></div> | Binding type for this license.   |
| ```                              | Can be either \'instance\' or    |
| ::: {#ansible_collection         | \'cluster\'. If omitted, then CM |
| s.thales.ciphertrust.license_cre | attempts to bind the license to  |
| ate_module__parameter-bind_type} | the cluster. If this step fails  |
| ::: {.rst-class}                 | with a lock code error, it will  |
| ansible-option-title             | attempt to bind to the instance. |
| :::                              |                                  |
| :::                              | ```{=html}                       |
|                                  | </div>                           |
| **bind\_type**                   | ```                              |
...
| r" id="parameter-license"></div> | License string                   |
| ```                              |                                  |
| ::: {#ansible_collecti           | ```{=html}                       |
| ons.thales.ciphertrust.license_c | </div>                           |
| reate_module__parameter-license} | ```                              |
| ::: {.rst-class}                 |                                  |
...
| s.thales.ciphertrust.license_cre | CipherTrust Manager (CM)         |
| ate_module__parameter-localnode} |                                  |
...
| ciphertrust.license_create_modul |                                  |
...
| iphertrust.license_create_module |                                  |
...
| hertrust.license_create_module__ | :::                              |
...
| st.license_create_module__parame | </div>                           |
...
| les.ciphertrust.license_create_m | ```                              |
...
| s.ciphertrust.license_create_mod | :::                              |
