...
@{
    ...
    FunctionsToExport = @(
        ...
        "Get-CM_CreateUser",
        "Get-CM_DeleteUser",
        "Get-CM_ListInterfaces",
        "Get-CM_AddInterface",
        "Get-CM_DeleteInterface",
        "Get-CM_ListLocalCAs",
        "Get-CM_ListCharacterSets",
        "Get-CM_CreateCharacterSet",
        "Get-CM_DeleteCharacterSet",
        "Get-CM_ListUserSets",
        "Get-CM_CreateUserSet",
        "Get-CM_DeleteUserSet",
        "Get-CM_ListMaskingFormats",
        "Get-CM_CreateMaskingFormat",
        "Get-CM_DeleteMaskingFormat",
        "Get-CM_ListProtectionPolicies",
        "Get-CM_CreateProtectionPolicy",
        "Get-CM_DeleteProtectionPolicy",
        "Get-CM_ListAccessPolicies",
        "Get-CM_CreateAccessPolicy",
        "Get-CM_DeleteAccessPolicy",
        "Get-CM_CreateUserSetPolicy",
        "Get-CM_DPG_ListPolicies",
        "Get-CM_DPG_CreatePolicy",
