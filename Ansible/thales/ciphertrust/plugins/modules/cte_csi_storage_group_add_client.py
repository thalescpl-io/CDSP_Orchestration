...
from ansible_collections.thales.ciphertrust.plugins.module_utils.cte import csigroup_add_client

DOCUMENTATION = '''
---
module: cte_csi_storage_group_add_client
